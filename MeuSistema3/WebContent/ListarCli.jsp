...
<body>
	<h1 style="color: white">Tabela De Cliente</h1>
			...
			try{
				...
				while(rs.next()){%>
					<tr align="100%" bgcolor="white">
						...
						<td><%out.println(rs.getString("empresa"));%></td>
						<td><%out.println(rs.getString("cnpj"));%></td>
						<td><%out.println(rs.getString("ramo"));%></td>
						<td><%out.println(rs.getString("contato"));%></td>
						<% out.println("<td><a href='http://localhost:8080/MeuSistema3/ListarCli.jsp?id="+ rs.getInt("id")+"'>(X)</td>"); %>
						<% out.println("<td><a href='http://localhost:8080/MeuSistema3/EditarCli.jsp?id="+ rs.getInt("id")+"'>(O)</td>"); %>
					</tr>
					<%
				}
